...
from bsadkhintest123ContigFilter.bsadkhintest123ContigFilterImpl import bsadkhintest123ContigFilter
from bsadkhintest123ContigFilter.bsadkhintest123ContigFilterServer import MethodContext
from bsadkhintest123ContigFilter.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class bsadkhintest123ContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('bsadkhintest123ContigFilter'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'bsadkhintest123ContigFilter',
        ...
        cls.serviceImpl = bsadkhintest123ContigFilter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_bsadkhintest123ContigFilter_" + str(suffix)
